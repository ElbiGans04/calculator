...
function Display(props) {
  ...
  for (let operation of operations) {
    ...
    let prevValue = checkDone.prev || parseInt(numbers[prev]);
    let nextValue = checkDone.next || parseInt(numbers[next]);
  ...
  console.log(operations, avoidVal)
  return (
...
function checkIfDone(listOperations, prev, next) {
  ...
  for (let operation of operations) {
    if (operation.done !== false) {
      // console.log(prev, next, operation)
      results.push({
        prev:
